...
templates['e_applicants_row'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<tr class=\"clickable applicant-row\" data-applicant-id="
    ...
    + " data-listing-id="
    + alias1(((helper = (helper = helpers.listing || (depth0 != null ? depth0.listing : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias2,{"name":"listing","hash":{},"data":data}) : helper)))
    + ">\n"
    + ((stack1 = helpers.each.call(alias2,(depth0 != null ? depth0.headers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</tr>";
...
templates['e_dash_page'] = template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!-- author: Maddie Dawson -->\n\n<div>\n\n  <h1>Welcome!</h1>\n\n  <button class=\"btn btn-primary right-align\" data-toggle=\"modal\" data-target=\"#newListingModal\">\n    Create New Listing\n  </button>\n  \n  <!-- New Listing Modal -->\n  <div class=\"modal fade\" id=\"newListingModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\">Create New Listing</h4>\n        </div>\n        <div class=\"modal-body\" id=\"new-listing-modal\"></div>\n      </div>\n    </div>\n  </div>\n\n  Here are your listings:\n\n  <br>\n  <br>\n\n  <table class=\"table table-hover table-condensed\">\n\n    <thead>\n  	  <th>Title</th>\n  	</thead>\n\n    <tbody>\n"
