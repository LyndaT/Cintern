...
templates['e_applicants_row'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"e_applicants_row\">\n	applicant row page\n    <tr class=\"applicant_row\" data-applicant-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.owner : depth0)) != null ? stack1._id : stack1), depth0))
    + " data-listing-id="
    + alias2(((helper = (helper = helpers.listing || (depth0 != null ? depth0.listing : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"listing","hash":{},"data":data}) : helper)))
    + ">\n      <td>"
...
templates['full_app'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var stack1, helper, alias1=container.escapeExpression;

  return "<div id=\"full-app\">\n	<h3>Common Application</h3>\n	"
    + alias1(((helper = (helper = helpers.isSubmitted || (depth0 != null ? depth0.isSubmitted : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"isSubmitted","hash":{},"data":data}) : helper)))
    + "\n	"
    + alias1(container.lambda((depths[1] != null ? depths[1].isSubmitted : depths[1]), depth0))
    + "\n"
    + ((stack1 = container.invokePartial(partials.application,(depth0 != null ? depth0.common : depth0),{"name":"application","hash":{"isSubmitted":(depth0 != null ? depth0.isSubmitted : depth0)},"data":data,"indent":"\t","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "	<h3>Custom Application</h3>\n"
    + ((stack1 = container.invokePartial(partials.application,(depth0 != null ? depth0.custom : depth0),{"name":"application","hash":{"isSubmitted":(depths[1] != null ? depths[1].isSubmitted : depths[1])},"data":data,"indent":"\t","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>";
},"usePartial":true,"useData":true,"useDepths":true});
