...
templates['e_dash_page'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return ((stack1 = container.invokePartial(partials.e_dash_page_listing,depth0,{"name":"e_dash_page_listing","hash":{"map":(depths[1] != null ? depths[1].map : depths[1]),"listingid":((stack1 = blockParams[0][0]) != null ? stack1._id : stack1),"listing":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"3":function(container,depth0,helpers,partials,data) {
...
templates['e_dash_page_listing'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- author: Maddie Dawson -->\n\n<div class=\"employer-dash-listing\">\n    <tr class=\"clickable listing-row\" data-listing-id="
    ...
    + "</td>\n  	  <td>"
    + alias3((helpers.getValue || (depth0 && depth0.getValue) || alias2).call(alias1,(depth0 != null ? depth0.map : depth0),(depth0 != null ? depth0.listingid : depth0),{"name":"getValue","hash":{},"data":data}))
    + "</td>\n  	  <td>"
...
templates['s_listing_row'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- author: Heeyoon Kim -->\n\n<div>\n"
    + ((stack1 = (helpers["in"] || (depth0 && depth0["in"]) || alias2).call(alias1,(depth0 != null ? depth0.submitted : depth0),(depth0 != null ? depth0._id : depth0),{"name":"in","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "    \n      <td>"
    ...
    + "</td>\n      <td>"
    + alias3(((helper = (helper = helpers.deadline || (depth0 != null ? depth0.deadline : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"deadline","hash":{},"data":data}) : helper)))
    + "</td>\n    </tr>\n</div>\n";
},"useData":true});
templates['s_listings'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(partials.listing,depth0,{"name":"listing","hash":{"submitted":(depths[1] != null ? depths[1].submitted : depths[1])},"data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"5":function(container,depth0,helpers,partials,data) {
