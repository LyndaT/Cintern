...
templates['e_applicants'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<<<<<<< HEAD:Cintern/templates/e_applicants.handlebars\n<div id=\"e-applicants\">\n=======\n<a href='/employers'>Back to Dash</a>\n<div class=\"e_applicants\">\n>>>>>>> mvp:templates/e_applicants.handlebars\n  <h1>Applicants</h1>\n    <p>Currently "
...
templates['login'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"signin\">\n  <div class=\"error\" id=\"login-error\">\n"
    ...
    + "  </div>\n<<<<<<< HEAD:Cintern/templates/login.handlebars\n=======\n\n>>>>>>> mvp:templates/login.handlebars\n  <br>\n  \n  <form id=\"login-form\" class=\"form-horizontal\">\n    <div class=\"form-group\">\n      <label class=\"control-label col-xs-2\">Email:</label>\n      <div class=\"col-xs-6\">\n        <input class=\"form-control\" type=\"text\" name=\"email\" required placeholder=\"Email\"/>\n      </div>\n    </div>\n    <div class = \"form-group\">\n      <label class=\"control-label col-xs-2\">Password:</label>\n      <div class=\"col-xs-6\">\n        <input class=\"form-control\" type=\"password\" name=\"password\" required placeholder=\"Password\"/>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"col-xs-offset-2 col-xs-6\">\n        <input class=\"btn btn-primary\" type=\"submit\" />\n      </div>\n    </div> \n  </form>\n</div>\n";
},"useData":true});
...
templates['s_dash_page_app'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- author: Maddie Dawson -->\n\n<div class=\"student-dash-app\">\n  <tr class=\"clickable student-app\" data-listing-id="
...
templates['s_listing'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div>\n	<a href=\"/students\"</a> Back to Dash</a>\n</div>\n\n<div class=\"listing\">\n	<label>Company: </label> "
    ...
    + "</p>\n\n	<br>\n	<br>\n\n	<button class=\"btn btn-primary\" id=\"add-app\" data-listing-id="
    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
